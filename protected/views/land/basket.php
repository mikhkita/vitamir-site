            ...
            <div class="">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <h2>Набор для набора массы</h2>
                                <a href="#">Посмотреть подробнее</a>
                            </td>
                            <td>1 день</td>
                            <td>
                                <h4>1190 руб.</h4>
                ...
                <input type="text">
                <button type="button" class="b-orange-butt"></button>
                <a class="sale" href="#">Получить промокод на скидку</a>
            </div>
            <div class="clearfix">
                <button type="submit" class="right">оформить заказ</button>
            </div>
        </div>
    </div>
